...
g = nx.Graph()
help(nx.Graph()) #to know about some thing use help
...
class Graph(builtins.object)
 ...
 |      AtlasView({1: {}})
 |  
 |  __init__(self, incoming_graph_data=None, **attr)
...
'a' in g.nodes
True
g.degree('a')# number of neighbors
4
SG = nx.read_adjlist('./Sallam.adjlist')
SG
<networkx.classes.graph.Graph at 0x16c00f21760>
